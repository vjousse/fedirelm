module Fediverse.GoToSocial.Entities.Account exposing (..)

import Fediverse.Entities.Account as FediverseAccount
import Fediverse.GoToSocial.Entities.Emoji exposing (Emoji, emojiDecoder, emojiEncoder)
import Fediverse.GoToSocial.Entities.Field exposing (Field, fieldDecoder, fieldEncoder, toField)
import Fediverse.GoToSocial.Entities.Role exposing (Role, roleDecoder, roleEncoder)
import Fediverse.GoToSocial.Entities.Source exposing (Source, sourceDecoder, sourceEncoder, toSource)
import Iso8601
...
accountDecoder =
    Decode.succeed Account
        ...
        |> Pipe.optional "enable_rss" (Decode.nullable Decode.bool) Nothing
...
accountEncoder a =
    Encode.object
        ...
        , ( "enable_rss", a.enableRss |> Maybe.map Encode.bool |> Maybe.withDefault Encode.null )
